...
Version  : 7.92
Release  : 17
URL      : https://nmap.org/dist/nmap-7.92.tgz
Source0  : https://nmap.org/dist/nmap-7.92.tgz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628549528
...
cp %{_builddir}/nmap-7.92/docs/licenses/LIBLINEAR-license.txt %{buildroot}/usr/share/package-licenses/nmap/11b4aab10a36cb53cbc34914898f370c012e714e
cp %{_builddir}/nmap-7.92/docs/licenses/Lua-license.txt %{buildroot}/usr/share/package-licenses/nmap/d2da2bd4f8577c12e667ea04e332f2a6561c6301
cp %{_builddir}/nmap-7.92/docs/licenses/OpenSSL-license.txt %{buildroot}/usr/share/package-licenses/nmap/102073b66c9be39953f62af2eb238629f7d50883
cp %{_builddir}/nmap-7.92/docs/licenses/PCRE-license.txt %{buildroot}/usr/share/package-licenses/nmap/c5acb2598e023ab1d8b4ac2db0914c70f0f89765
cp %{_builddir}/nmap-7.92/docs/licenses/WinPcap-license.txt %{buildroot}/usr/share/package-licenses/nmap/29728470b493ed96abab2cb93352c03270964a17
cp %{_builddir}/nmap-7.92/libdnet-stripped/LICENSE %{buildroot}/usr/share/package-licenses/nmap/81d129de3c04aac48847d12ce0062b19e528530a
cp %{_builddir}/nmap-7.92/liblinear/COPYRIGHT %{buildroot}/usr/share/package-licenses/nmap/11b4aab10a36cb53cbc34914898f370c012e714e
cp %{_builddir}/nmap-7.92/libpcap/LICENSE %{buildroot}/usr/share/package-licenses/nmap/bf0cb439d0ca55615b5060ee09d77af3ddc9518d
cp %{_builddir}/nmap-7.92/libpcre/LICENCE %{buildroot}/usr/share/package-licenses/nmap/c5acb2598e023ab1d8b4ac2db0914c70f0f89765
cp %{_builddir}/nmap-7.92/libssh2/COPYING %{buildroot}/usr/share/package-licenses/nmap/aaf482b05d3bc738542f5ee97d842b7e82daba8c
cp %{_builddir}/nmap-7.92/libz/contrib/dotzlib/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/nmap/892b34f7865d90a6f949f50d95e49625a10bc7f0
cp %{_builddir}/nmap-7.92/zenmap/COPYING_HIGWIDGETS %{buildroot}/usr/share/package-licenses/nmap/8a3a8c1dc994733d0e0bcb6ebac1b533c6935d4b
%make_install
...
/usr/share/package-licenses/nmap/aaf482b05d3bc738542f5ee97d842b7e82daba8c
