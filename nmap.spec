...
License  : BSD-3-Clause BSL-1.0 GPL-2.0 LGPL-2.1 MIT OpenSSL Zlib
...
Requires: nmap-python = %{version}-%{release}
Requires: nmap-python3 = %{version}-%{release}
...
Patch1: 0001-Don-t-strip-the-executables-upon-installation.patch
Patch2: 0002-Make-Python-pip-installation-work-offline.patch
...
%package data
Summary: data components for the nmap package.
Group: Data
...
%description license
license components for the nmap package.


%package man
Summary: man components for the nmap package.
Group: Default

%description man
man components for the nmap package.


%package python
Summary: python components for the nmap package.
Group: Default
Requires: nmap-python3 = %{version}-%{release}

%description python
python components for the nmap package.


%package python3
Summary: python3 components for the nmap package.
Group: Default
Requires: python3-core
Requires: pypi(pygobject)

%description python3
python3 components for the nmap package.


%prep
%setup -q -n nmap-7.95
cd %{_builddir}/nmap-7.95
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a nmap-7.95 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714160564
...
cp %{_builddir}/nmap-%{version}/docs/licenses/LIBLINEAR-license.txt %{buildroot}/usr/share/package-licenses/nmap/11b4aab10a36cb53cbc34914898f370c012e714e || :
cp %{_builddir}/nmap-%{version}/docs/licenses/Libdnet-license.txt %{buildroot}/usr/share/package-licenses/nmap/8a7d9026468153574b91528092fd891dd62f70c7 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/Libdnet-license.txt %{buildroot}/usr/share/package-licenses/nmap/8a7d9026468153574b91528092fd891dd62f70c7 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/Lua-license.txt %{buildroot}/usr/share/package-licenses/nmap/d2da2bd4f8577c12e667ea04e332f2a6561c6301 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/Lua-license.txt %{buildroot}/usr/share/package-licenses/nmap/d2da2bd4f8577c12e667ea04e332f2a6561c6301 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/OpenSSL-license.txt %{buildroot}/usr/share/package-licenses/nmap/102073b66c9be39953f62af2eb238629f7d50883 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/OpenSSL-license.txt %{buildroot}/usr/share/package-licenses/nmap/102073b66c9be39953f62af2eb238629f7d50883 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/PCRE-license.txt %{buildroot}/usr/share/package-licenses/nmap/c5acb2598e023ab1d8b4ac2db0914c70f0f89765 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/PCRE-license.txt %{buildroot}/usr/share/package-licenses/nmap/c5acb2598e023ab1d8b4ac2db0914c70f0f89765 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/WinPcap-license.txt %{buildroot}/usr/share/package-licenses/nmap/29728470b493ed96abab2cb93352c03270964a17 || :
cp %{_builddir}/nmap-%{version}/docs/licenses/WinPcap-license.txt %{buildroot}/usr/share/package-licenses/nmap/29728470b493ed96abab2cb93352c03270964a17 || :
cp %{_builddir}/nmap-%{version}/libdnet-stripped/LICENSE %{buildroot}/usr/share/package-licenses/nmap/81d129de3c04aac48847d12ce0062b19e528530a || :
cp %{_builddir}/nmap-%{version}/liblinear/COPYRIGHT %{buildroot}/usr/share/package-licenses/nmap/32e963241bc62a538620f51c821b6a51ed0f9df0 || :
cp %{_builddir}/nmap-%{version}/libpcap/LICENSE %{buildroot}/usr/share/package-licenses/nmap/bf0cb439d0ca55615b5060ee09d77af3ddc9518d || :
cp %{_builddir}/nmap-%{version}/libpcre/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/nmap/ff3ed70db4739b3c6747c7f624fe2bad70802987 || :
cp %{_builddir}/nmap-%{version}/libz/LICENSE %{buildroot}/usr/share/package-licenses/nmap/233f44af3fb55dcc7fddfef8e77ac627b0008756 || :
cp %{_builddir}/nmap-%{version}/libz/contrib/dotzlib/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/nmap/892b34f7865d90a6f949f50d95e49625a10bc7f0 || :
cp %{_builddir}/nmap-%{version}/zenmap/COPYING_HIGWIDGETS %{buildroot}/usr/share/package-licenses/nmap/8a3a8c1dc994733d0e0bcb6ebac1b533c6935d4b || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/share/package-licenses/nmap/102073b66c9be39953f62af2eb238629f7d50883
/usr/share/package-licenses/nmap/11b4aab10a36cb53cbc34914898f370c012e714e
/usr/share/package-licenses/nmap/233f44af3fb55dcc7fddfef8e77ac627b0008756
/usr/share/package-licenses/nmap/29728470b493ed96abab2cb93352c03270964a17
/usr/share/package-licenses/nmap/32e963241bc62a538620f51c821b6a51ed0f9df0
/usr/share/package-licenses/nmap/81d129de3c04aac48847d12ce0062b19e528530a
/usr/share/package-licenses/nmap/892b34f7865d90a6f949f50d95e49625a10bc7f0
/usr/share/package-licenses/nmap/8a3a8c1dc994733d0e0bcb6ebac1b533c6935d4b
/usr/share/package-licenses/nmap/8a7d9026468153574b91528092fd891dd62f70c7
/usr/share/package-licenses/nmap/bf0cb439d0ca55615b5060ee09d77af3ddc9518d
/usr/share/package-licenses/nmap/c5acb2598e023ab1d8b4ac2db0914c70f0f89765
/usr/share/package-licenses/nmap/d2da2bd4f8577c12e667ea04e332f2a6561c6301
/usr/share/package-licenses/nmap/ff3ed70db4739b3c6747c7f624fe2bad70802987
