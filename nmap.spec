...
Source0  : https://nmap.org/dist/nmap-7.94.tgz
...
%prep
%setup -q -n nmap-7.94
cd %{_builddir}/nmap-7.94
%patch -P 1 -p1
pushd ..
cp -a nmap-7.94 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702040619
...
cp %{_builddir}/nmap-%{version}/liblinear/COPYRIGHT %{buildroot}/usr/share/package-licenses/nmap/11b4aab10a36cb53cbc34914898f370c012e714e || :
...
cp %{_builddir}/nmap-%{version}/libpcre/LICENCE %{buildroot}/usr/share/package-licenses/nmap/c5acb2598e023ab1d8b4ac2db0914c70f0f89765 || :
cp %{_builddir}/nmap-%{version}/libssh2/COPYING %{buildroot}/usr/share/package-licenses/nmap/19b306b372fdae0f6390c0d4192c2a8f7973dac7 || :
...
/usr/share/package-licenses/nmap/19b306b372fdae0f6390c0d4192c2a8f7973dac7
